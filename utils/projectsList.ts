...
const projects = [
  ...
  },
  {
    ...
    body: "A full-stack healthcare management system featuring appointment scheduling, patient records, WhatsApp chatbot integration, prescription management, and accounting modules.",
    chips: [
      tech("react"),
      tech("tailwind"),
      tech("typescript"),
