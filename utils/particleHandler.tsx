class Particle {
    ...
    constructor(x: number, y: number, xVector: number, yVector: number, xLimit: number, yLimit: number) {
        this.x = x;
        this.y = y;
    ...
    move(): void {
        ...
        this.xVector = this.x < 1 || this.x > this.xLimit - 1 ? this.xVector * -1 : this.xVector;

        // if it hits the top/bottom wall
        this.yVector = this.y < 1 || this.y > this.yLimit - 1 ? this.yVector * -1 : this.yVector;
    }
}
